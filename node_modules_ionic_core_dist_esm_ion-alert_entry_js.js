...
/* harmony import */ var _button_active_2da0f611_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./button-active-2da0f611.js */ 9228);
/* harmony import */ var _helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers-3379ba19.js */ 4259);
/* harmony import */ var _overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./overlays-c3387ec0.js */ 5732);
/* harmony import */ var _theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./theme-17531cdf.js */ 9908);
/* harmony import */ var _ionic_global_1ef19007_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ionic-global-1ef19007.js */ 1904);
...
/* harmony import */ var _framework_delegate_2b76c681_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./framework-delegate-2b76c681.js */ 1286);
...
const Alert = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertDidPresent", 7);
    this.willPresent = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertWillPresent", 7);
    this.willDismiss = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertWillDismiss", 7);
    this.didDismiss = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionAlertDidDismiss", 7);
    ...
    this.delegateController = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.d)(this);
    this.triggerController = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.e)();
    this.customHTMLEnabled = _ionic_global_1ef19007_js__WEBPACK_IMPORTED_MODULE_7__.c.get('innerHTMLTemplatesEnabled', _config_96c9ace3_js__WEBPACK_IMPORTED_MODULE_2__.E);
    this.processedInputs = [];
    this.processedButtons = [];
    this.presented = false;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.B);
    };
    this.dispatchCancelHandler = ev => {
      const role = ev.detail.role;
      if ((0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.i)(role)) {
  ...
  connectedCallback() {
    (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.j)(this.el);
    this.triggerChanged();
  }
  componentWillLoad() {
    (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.k)(this.el);
    this.inputsChanged();
    this.buttonsChanged();
  }
  ...
  componentDidLoad() {
     ...
     */
    if (!this.gesture && (0,_ionic_global_1ef19007_js__WEBPACK_IMPORTED_MODULE_7__.b)(this) === 'ios' && this.wrapperEl) {
      this.gesture = (0,_button_active_2da0f611_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.wrapperEl, refEl => refEl.classList.contains('alert-button'));
  ...
  present() {
    ...
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.currentTransition = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
      yield _this.currentTransition;
  ...
  dismiss(data, role) {
    var _this2 = this;
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.currentTransition = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
   ...
   */
  onDidDismiss() {
    return (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionAlertDidDismiss');
  }
  /**
   * Returns a promise that resolves when the alert will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionAlertWillDismiss');
  }
  rbClick(selectedInput) {
    ...
    (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.s)(selectedInput.handler, selectedInput);
  ...
  callButtonHandler(button, data) {
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        const returnData = yield (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.s)(button.handler, data);
        if (returnData === false) {
  ...
  renderCheckbox() {
    ...
    const mode = (0,_ionic_global_1ef19007_js__WEBPACK_IMPORTED_MODULE_7__.b)(this);
    if (inputs.length === 0) {
      return null;
    }
    return (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "alert-checkbox-group"
    }, inputs.map(i => (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      type: "button",
      ...
      tabIndex: i.tabindex,
      role: "checkbox",
      class: Object.assign(Object.assign({}, (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_6__.g)(i.cssClass)), {
        'alert-tappable': true,
        'alert-checkbox': true,
    ...
    }, i.label)), mode === 'md' && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null))));
  }
  renderRadio() {
    const inputs = this.processedInputs;
    if (inputs.length === 0) {
  ...
  renderInput() {
    ...
    return (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      if (i.type === 'textarea') {
        ...
        }, (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("textarea", Object.assign({
          placeholder: i.placeholder,
          value: i.value,
          id: i.id,
          tabIndex: i.tabindex
  ...
  renderAlertButtons() {
    ...
    return (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    }, buttons.map(button => (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, button.htmlAttributes, {
      type: "button",
      id: button.id,
      ...
      class: "alert-button-inner"
    }, button.text), mode === 'md' && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null))));
  }
  ...
  render() {
    ...
    return (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      class: "alert-head"
    }, header && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("h2", {
      id: hdrId,
      class: "alert-title"
    }, header), subHeader && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("h2", {
      id: subHdrId,
      class: "alert-sub-title"
    }, subHeader)), this.renderAlertMessage(msgId), this.renderAlertInputs(), this.renderAlertButtons()), (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      tabindex: "0"
    }));
  }
  get el() {
...
const inputClass = input => {
  ...
  }, (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_6__.g)(input.cssClass)), (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_6__.g)(input.attributes ? (_c = input.attributes.class) === null || _c === void 0 ? void 0 : _c.toString() : ''));
};
