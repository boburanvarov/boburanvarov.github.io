...
/* harmony import */ var _framework_delegate_2b76c681_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./framework-delegate-2b76c681.js */ 1286);
...
/* harmony import */ var _index_6391de89_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-6391de89.js */ 5701);
...
const configureKeyboardInteraction = popoverEl => {
  const callback = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
      var _a;
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const contentAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_9__.c)();
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  const contentAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const viewportAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  backdropAnimation.addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidPresent", 7);
    this.willPresent = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillPresent", 7);
    this.willDismiss = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverWillDismiss", 7);
    this.didDismiss = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionPopoverDidDismiss", 7);
    ...
    this.coreDelegate = (0,_framework_delegate_2b76c681_js__WEBPACK_IMPORTED_MODULE_2__.C)();
    this.inline = false;
    ...
    this.configureTriggerInteraction = () => {
      ...
      if (!triggerEl) {
        (0,_index_595d62c9_js__WEBPACK_IMPORTED_MODULE_4__.p)(`A trigger element with the ID "${trigger}" was not found in the DOM. The trigger element must be in the DOM when the "trigger" property is set on ion-popover.`, this.el);
        return;
      }
  ...
  connectedCallback() {
    ...
    (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.k)(el);
    this.parentPopover = el.closest(`ion-popover:not(#${popoverId})`);
    if (this.alignment === undefined) {
      this.alignment = (0,_ionic_global_1ef19007_js__WEBPACK_IMPORTED_MODULE_6__.b)(this) === 'ios' ? 'center' : 'start';
    }
  }
  componentDidLoad() {
    const {
  ...
  present(event) {
    ...
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_2b76c681_js__WEBPACK_IMPORTED_MODULE_2__.a)(delegate, el, _this2.component, ['popover-viewport'], _this2.componentProps, inline);
      ...
      if ((0,_helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_3__.m)(el)) {
        yield (0,_index_6391de89_js__WEBPACK_IMPORTED_MODULE_8__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_6391de89_js__WEBPACK_IMPORTED_MODULE_8__.w)();
      }
      _this2.currentTransition = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.o)(_this2.el, _this2.el);
      }
    })();
  }
  /**
  ...
  dismiss(data, role, dismissParentPopover = true) {
    ...
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this3.currentTransition = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this3, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this3.event);
      ...
      if (shouldDismiss) {
        ...
        yield (0,_framework_delegate_2b76c681_js__WEBPACK_IMPORTED_MODULE_2__.d)(delegate, _this3.usersElement);
      }
   ...
   */
  onDidDismiss() {
    return (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    const desktop = (0,_ionic_global_1ef19007_js__WEBPACK_IMPORTED_MODULE_6__.a)('desktop');
    ...
    }), !parentPopover && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-backdrop", {
    ...
    }, enableArrow && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "popover-arrow",
      part: "arrow"
    }), (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
