...
/* harmony import */ var _button_active_2da0f611_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./button-active-2da0f611.js */ 9228);
/* harmony import */ var _helpers_3379ba19_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers-3379ba19.js */ 4259);
/* harmony import */ var _overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./overlays-c3387ec0.js */ 5732);
/* harmony import */ var _theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./theme-17531cdf.js */ 9908);
/* harmony import */ var _ionic_global_1ef19007_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ionic-global-1ef19007.js */ 1904);
/* harmony import */ var _animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./animation-a1d9e088.js */ 7143);
/* harmony import */ var _haptic_6447af60_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./haptic-6447af60.js */ 3416);
/* harmony import */ var _capacitor_b4979570_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./capacitor-b4979570.js */ 7967);
/* harmony import */ var _index_7a14ecec_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-7a14ecec.js */ 2678);
/* harmony import */ var _index_ff313b19_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./index-ff313b19.js */ 873);
/* harmony import */ var _gesture_controller_0fa396c4_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./gesture-controller-0fa396c4.js */ 9212);
...
/* harmony import */ var _index_595d62c9_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./index-595d62c9.js */ 2957);
...
const iosEnterAnimation = baseEl => {
  const baseAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const backdropAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_7__.c)();
  const wrapperAnimation = (0,_animation_a1d9e088_js__WEBPACK_IMPORTED_MODULE_7__.c)();
...
const ActionSheet = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionActionSheetDidPresent", 7);
    this.willPresent = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionActionSheetWillPresent", 7);
    this.willDismiss = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionActionSheetWillDismiss", 7);
    this.didDismiss = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionActionSheetDidDismiss", 7);
    ...
    this.delegateController = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.d)(this);
    this.triggerController = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.e)();
    this.presented = false;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.B);
    };
    this.dispatchCancelHandler = ev => {
      const role = ev.detail.role;
      if ((0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.i)(role)) {
  ...
  present() {
    ...
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.currentTransition = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.f)(_this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
      yield _this.currentTransition;
  ...
  dismiss(data, role) {
    var _this2 = this;
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.currentTransition = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.g)(_this2, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
   ...
   */
  onDidDismiss() {
    return (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.h)(this.el, 'ionActionSheetDidDismiss');
  }
  /**
   ...
   */
  onWillDismiss() {
    return (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.h)(this.el, 'ionActionSheetWillDismiss');
  }
  buttonClick(button) {
    var _this3 = this;
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  callButtonHandler(button) {
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button) {
        ...
        const rtn = yield (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.s)(button.handler);
        if (rtn === false) {
  ...
  connectedCallback() {
    (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.j)(this.el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_4__.k)(this.el);
  }
  componentDidLoad() {
    /**
    ...
    if (!this.gesture && (0,_ionic_global_1ef19007_js__WEBPACK_IMPORTED_MODULE_6__.b)(this) === 'ios' && wrapperEl && groupEl) {
      (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.e)(() => {
        const isScrollable = groupEl.scrollHeight > groupEl.clientHeight;
        if (!isScrollable) {
          this.gesture = (0,_button_active_2da0f611_js__WEBPACK_IMPORTED_MODULE_2__.c)(wrapperEl, refEl => refEl.classList.contains('action-sheet-button'));
  ...
  render() {
    ...
    const mode = (0,_ionic_global_1ef19007_js__WEBPACK_IMPORTED_MODULE_6__.b)(this);
    ...
    return (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      class: Object.assign(Object.assign({
        [mode]: true
      }, (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_5__.g)(this.cssClass)), {
        'overlay-hidden': true,
    ...
    }, header !== undefined && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      id: headerID,
      class: {
        'action-sheet-title': true,
        'action-sheet-has-sub-title': this.subHeader !== undefined
      }
    }, header, this.subHeader && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "action-sheet-sub-title"
    }, this.subHeader)), buttons.map(b => (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, b.htmlAttributes, {
      type: "button",
      id: b.id,
      class: buttonClass(b),
    ...
    }, b.icon && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      icon: b.icon,
      "aria-hidden": "true",
      lazy: false,
      class: "action-sheet-icon"
    }), b.text), mode === 'md' && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null)))), cancelButton && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "action-sheet-group action-sheet-group-cancel"
    }, (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, cancelButton.htmlAttributes, {
      type: "button",
      class: buttonClass(cancelButton),
      onClick: () => this.buttonClick(cancelButton)
    }), (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("span", {
      class: "action-sheet-button-inner"
    }, cancelButton.icon && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      icon: cancelButton.icon,
      "aria-hidden": "true",
      lazy: false,
      class: "action-sheet-icon"
    }), cancelButton.text), mode === 'md' && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", null))))), (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      tabindex: "0"
    }));
  }
  get el() {
...
const buttonClass = button => {
  ...
  }, (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_5__.g)(button.cssClass));
};
ActionSheet.style = {
