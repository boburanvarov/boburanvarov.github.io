...
/* harmony import */ var _framework_delegate_2b76c681_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./framework-delegate-2b76c681.js */ 1286);
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidPresent", 7);
    this.willPresent = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillPresent", 7);
    this.willDismiss = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastWillDismiss", 7);
    this.didDismiss = (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.d)(this, "ionToastDidDismiss", 7);
    ...
    this.duration = _ionic_global_1ef19007_js__WEBPACK_IMPORTED_MODULE_7__.c.getNumber('toastDuration', 0);
  ...
  present() {
    ...
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.currentTransition = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, _this.position);
      yield _this.currentTransition;
      /**
  ...
  dismiss(data, role) {
    ...
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.currentTransition = (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, _this2.position);
   ...
   */
  onDidDismiss() {
    return (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  callButtonHandler(button) {
    return (0,C_Users_User_Desktop_ionic_conference_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          const rtn = yield (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.s)(button.handler);
          if (rtn === false) {
  ...
  renderButtons(buttons, side) {
    ...
    }, buttons.map(b => (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, b.htmlAttributes, {
      type: "button",
      class: buttonClass(b),
      tabIndex: 0,
    ...
    }), b.text), mode === 'md' && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
  ...
  render() {
    ...
    if (layout === 'stacked' && startButtons.length > 0 && endButtons.length > 0) {
      (0,_index_595d62c9_js__WEBPACK_IMPORTED_MODULE_4__.p)('This toast is using start and end buttons with the stacked toast layout. We recommend following the best practice of using either start or end buttons with the stacked toast layout.', el);
    }
    return (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.H, Object.assign({
      ...
      class: (0,_theme_17531cdf_js__WEBPACK_IMPORTED_MODULE_6__.c)(this.color, Object.assign(Object.assign({
        [mode]: true
      ...
      part: "container"
    }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && (0,_index_847f2fde_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      class: "toast-icon",
      part: "icon",
      icon: this.icon,
      lazy: false,
...
const buttonPart = button => {
  return (0,_overlays_c3387ec0_js__WEBPACK_IMPORTED_MODULE_5__.i)(button.role) ? 'button cancel' : 'button';
};
Toast.style = {
  ios: toastIosCss,
  md: toastMdCss
